    ...
    return (
        <div className="main-section">
            ...
            <div className="main-section__bg">
                <svg width="375" height="511" viewBox="0 0 375 511" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.24" filter="url(#filter0_f_80_14521)">
                    <circle cx="188.04" cy="245.959" r="124.272" transform="rotate(92.6861 188.04 245.959)" fill="#71B21D"/>
                    </g>
                    <defs>
                    <filter id="filter0_f_80_14521" x="-76.2342" y="-18.3155" width="528.549" height="528.549" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                    <feGaussianBlur stdDeviation="70" result="effect1_foregroundBlur_80_14521"/>
                    </filter>
                    </defs>
                </svg>
            </div>
            <SettingsPopup setActivePopup={setActivePopup} activePopup={activePopup} />
        </div>
    )
}
