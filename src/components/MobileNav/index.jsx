        ...
        <div className="mobile-nav">
            <ul className="mobile-menu f-center-jcsb">
                <li className="mobile-menu__item">
                    <NavLink to={routeMain()} className="mobile-menu__card" activeClassName={'active'}>
                        <div className="mobile-menu__icon f-center-center">
                            <div className="mobile-menu__icon_white">
                                <img src={GameDefaultWhite} alt="" className="mobile-menu__icon_white-default" />
                                <img src={GameActiveWhite} alt="" className="mobile-menu__icon_white-active" />
                            </div>
                            <div className="mobile-menu__icon_dark">
                                <img src={GameDefaultDark} alt="" className="mobile-menu__icon_dark-default" />
                                <img src={GameActiveDark} alt="" className="mobile-menu__icon_dark-active" />
                            </div>
                        </div>
                ...
                <li className="mobile-menu__item">
                    <NavLink to={routeCity()} className="mobile-menu__card">
                        <div className="mobile-menu__icon f-center-center">
                            <div className="mobile-menu__icon f-center-center">
                                <div className="mobile-menu__icon_white">
                                    <img src={CityDefaultWhite} alt="" className="mobile-menu__icon_white-default" />
                                    <img src={CityActiveWhite} alt="" className="mobile-menu__icon_white-active" />
                                </div>
                                <div className="mobile-menu__icon_dark">
                                    <img src={CityDefaultDark} alt="" className="mobile-menu__icon_dark-default" />
                                    <img src={CityActiveDark} alt="" className="mobile-menu__icon_dark-active" />
                                </div>
                            </div>
                        </div>
                        <p className="mobile-menu__title">
                ...
                <li className="mobile-menu__item">
                    <NavLink to={routePeople()} className="mobile-menu__card">
                        <div className="mobile-menu__icon f-center-center">
                            <div className="mobile-menu__icon_white">
                                <img src={PeopleDefaultWhite} alt="" className="mobile-menu__icon_white-default" />
                                <img src={PeopleActiveWhite} alt="" className="mobile-menu__icon_white-active" />
                            </div>
                            <div className="mobile-menu__icon_dark">
                                <img src={PeopleDefaultDark} alt="" className="mobile-menu__icon_dark-default" />
                                <img src={PeopleActiveDark} alt="" className="mobile-menu__icon_dark-active" />
                            </div>
                        </div>
                        <p className="mobile-menu__title">
                            Жители
                ...
                <li className="mobile-menu__item">
                    <NavLink to={routeFriends()} className="mobile-menu__card">
                        <div className="mobile-menu__icon f-center-center">
                            <div className="mobile-menu__icon_white">
                                <img src={FriendsDefaultWhite} alt="" className="mobile-menu__icon_white-default" />
                                <img src={FriendsActiveWhite} alt="" className="mobile-menu__icon_white-active" />
                            </div>
                            <div className="mobile-menu__icon_dark">
                                <img src={FriendsDefaultDark} alt="" className="mobile-menu__icon_dark-default" />
                                <img src={FriendsActiveDark} alt="" className="mobile-menu__icon_dark-active" />
                            </div>
                        </div>
                        <p className="mobile-menu__title">
                            Друзья
                ...
                <li className="mobile-menu__item">
                    <NavLink to={routeShop()} className="mobile-menu__card">
                        <div className="mobile-menu__icon f-center-center">
                            <div className="mobile-menu__icon_white">
                                <img src={ShopDefaultWhite} alt="" className="mobile-menu__icon_white-default" />
                                <img src={ShopActiveWhite} alt="" className="mobile-menu__icon_white-active" />
                            </div>
                            <div className="mobile-menu__icon_dark">
                                <img src={ShopDefaultDark} alt="" className="mobile-menu__icon_dark-default" />
                                <img src={ShopActiveDark} alt="" className="mobile-menu__icon_dark-active" />
                            </div>
                        </div>
                        <p className="mobile-menu__title">
                            Магазин
