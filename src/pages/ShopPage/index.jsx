                                ...
                                <ul className="shop-list f-jcsb">
                                    <li className="shop-list__item">
                                        <div className="shop-list__card">
                                            <div className="shop-list__image" onClick={() => handleOpenPopup()}>
...
в 2-3 строки
            ...
            <div ref={filterRef} className={`modal shop-filter ${activePopupFilter && 'show'}`}>
            ...
            <ShopPopup active={activePopup} setActivePopup={setActivePopup} handleClosePopup={handleClosePopup} />
            <MobileNav />
        </section>
    )
};
